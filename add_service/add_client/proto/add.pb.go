...
func (x *AddReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddReponse) ProtoMessage() {}

func (x *AddReponse) ProtoReflect() protoreflect.Message {
	mi := &file_add_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddReponse.ProtoReflect.Descriptor instead.
func (*AddReponse) Descriptor() ([]byte, []int) {
	return file_add_proto_rawDescGZIP(), []int{1}
}

func (x *AddReponse) GetResult() int64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_add_proto_rawDesc = []byte{
	...
	,
...
var file_add_proto_goTypes = []interface{}{
	...
	(*AddReponse)(nil), // 1: proto.AddReponse
}
var file_add_proto_depIdxs = []int32{
	0, // 0: proto.CalcService.Add:input_type -> proto.AddRequest
	1, // 1: proto.CalcService.Add:output_type -> proto.AddReponse
