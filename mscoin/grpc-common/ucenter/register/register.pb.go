...
type RegReq struct {
	...
	Captcha      *CaptchaReq `protobuf:"bytes,3,opt,name=captcha,proto3" json:"captcha,omitempty"` //人机验证
	Phone        string      `protobuf:"bytes,4,opt,name=phone,proto3" json:"phone,omitempty"`
	Promotion    string      `protobuf:"bytes,5,opt,name=promotion,proto3" json:"promotion,omitempty"` //邀请码
...
var file_register_proto_rawDesc = []byte{
	...
	0x72, 0x42, 0x79, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x10, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73,
